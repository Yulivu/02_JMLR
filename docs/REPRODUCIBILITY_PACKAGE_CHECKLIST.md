...
| table-generation scripts | done-for-review | `scripts/analysis/generate_paper_tables.py` regenerates `experiments/results/paper_tables/` from curated audit CSVs and `docs/FINAL_CLAIM_TABLE.md` |
...
```text
curated audit CSVs + docs/FINAL_CLAIM_TABLE.md -> scripts/analysis/generate_paper_tables.py -> experiments/results/paper_tables/
```
