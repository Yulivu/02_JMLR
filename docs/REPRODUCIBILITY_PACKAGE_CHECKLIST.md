...
| table-generation scripts | done-for-review | `scripts/analysis/generate_paper_tables.py` regenerates `experiments/results/paper_tables/` from curated audit CSVs |
...
```text
curated audit CSVs -> scripts/analysis/generate_paper_tables.py -> experiments/results/paper_tables/
```
