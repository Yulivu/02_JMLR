...
| Product automaton inference itself is new | CRF x automaton/product marginal inference is the known computational neighborhood; novelty must be object semantics, audit protocol, and empirical boundaries |
