...
| 是否能展示 hidden posterior conflict？ | yes in WNUT17 B0-B6 local stress smoke; formal multi-seed still required |
...
Formal R5 is frozen as two-regime rather than one-regime in `docs/R5_WNUT17_FORMAL_PROTOCOL.md`.
```
