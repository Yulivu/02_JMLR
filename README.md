...
方向、理论对象、实验工程路线已经固定；P3/P4 已本地通过，当前处在 P5/R5-prep：AutoDL/HPC 工程入口已本地准备，但目标机器 smoke 还没跑。论文路线已收缩到 posterior event semantics，P6 前 BIO/NER canonical benchmark 已冻结为 WNUT17，B0/B1/B4 local stress smoke 已跑通，B2/B3/B5/B6 formal runner 还没实现。
...
下一步：把 WNUT17 R5 BIO/NER 从 B0/B1/B4 smoke 扩展到 B0-B6，再做 AutoDL target-machine smoke；两者都通过后再进入 formal runs。
